...
/*function show_location_main(){
		$sql ="select * from locationcategory_details WHERE pid=0";
		//$this->db->where('pid', 0);
...
function show_location_sub($id)
	{
		$sql ="select * from locationcategory_details";
...
function location_edit($id, $datalist){
	
		$this->db->where('category_id', $id);
		$this->db->update('category',$datalist);
	}

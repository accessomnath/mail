        ...
        if (isset($menu['parents'][$parent])) {
            ...
            foreach ($menu['parents'][$parent] as $itemId) {
                if (!isset($menu['parents'][$itemId])) {
					...
					//echo $baseurl; exit();
                    $html .= "<div style='display: inline-flex; padding:10px;'>"."<li>". $menu['items'][$itemId]->category_name."</li>"."<a style='margin-left:10px;' href=".base_url()."index.php/location/show_location_id"."/".$menu['items'][$itemId]->category_id.">"."Edit"."</a>"."</div>"."<br>";
                }
                if (isset($menu['parents'][$itemId])) {
                    $html .= "<div style='display: inline-flex; padding:10px;'>"."<li>" . $menu['items'][$itemId]->category_name . "</li>"."<a style='margin-left:10px;' href=".base_url()."index.php/location/show_location_id"."/".$menu['items'][$itemId]->category_id.">"."Edit"."</a>"."</div>"."<br>";
